            ...
            <?php if(is_array($fields[$key])): $i = 0; $__LIST__ = $fields[$key];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i; if($field['is_show'] == 1 || $field['is_show'] == 2): ?><div class="form-item cf">
                    ...
                    <div class="controls">
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-mid" name="<?php echo ($field["name"]); ?>" value="<?php echo ($field["value"]); ?>"><?php break;?>
                            ...
                            <?php case "sort": ?><input type="text" class="text input-mid" name="<?php echo ($field["name"]); ?>" value="<?php echo ($field["value"]); ?>"><?php break;?>
                            ...
                            <?php case "pictures": echo hook('UploadImages', array('name'=>$field['name'],'value'=>$field['value'])); break;?>
                            <?php case "images": echo hook('UploadPic', array('name'=>$field['name'],'value'=>$field['value'])); break;?>
                            <?php case "file": ?><div class="controls">
									<input type="file" id="upload_file_<?php echo ($field["name"]); ?>">
									<!--<input type="hidden" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['id']]); ?>"/>-->
                                    <input type="hidden" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['id']]); ?>"/>
									<div class="upload-img-box">
