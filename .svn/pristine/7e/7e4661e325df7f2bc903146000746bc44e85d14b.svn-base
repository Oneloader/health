...
<link rel="stylesheet" type="text/css" href="/Public/Admin/css/sb/tree.css" /> 
...
<div class="sidebar-collapse">
  ...
  <div class="row"> 
    ...
    <div class="tree well">
        <ul>
          <li>     
            <span><i class="fa fa-sitemap fa-fw"></i>&nbsp;&nbsp;根节点</span><a class="btn btn-default" href="<?php echo U('add');?>">新增分类</a>
            <ul>
...
<script type="text/javascript" src="/Public/Admin/js/sb/tree.js"></script>
