...
<div class="panel panel-default">
    ...
    <div class="tab-wrap panel-body">
        ...
        <div class="row">         
            <!-- 表单 -->    
			<form id="form" action="<?php echo U('update');?>" method="post" class="form doc-modal-form col-lg-6" role="form" >
            ...
            <!-- 基础 -->
                <div class="tab-pane fade in active" id="tab1">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="field" value="<?php echo ($info["field"]); ?>" id="data-field">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="value" value="<?php echo ($info["value"]); ?>">
					</div>
					<div class="form-group">
                ...
                <div id="tab2" class="tab-pane  fade tab2">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="validate_rule" value="<?php echo ($info["validate_rule"]); ?>">
					</div>
					<div class="form-group">
						<label class="item-label">出错提示<span class="check-tips"></span></label>
                        <input type="text" class="form-control" name="error_info" value="<?php echo ($info["error_info"]); ?>">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="auto_rule" value="<?php echo ($info["auto_rule"]); ?>">
					</div>
					<div class="form-group">
