<?php if (!defined('THINK_PATH')) exit();?><div class='controls ' style='background: aliceblue;
    ...
    <script type="text/javascript" src="/Addons/UploadImages/js/jquery.sortable.js"></script>
...
//                    }
                    ...
                    html +='<label>职称:<input data-id="'+id+'" data-field="position" value="'+oValue[i].position+'"/></label>';
                    html +='<label>专业资历:<input data-id="'+id+'" data-field="seniority" value="'+oValue[i].seniority+'"/></label>';
                    html +='<label>擅长:<input data-id="'+id+'" data-field="introduce" value="'+oValue[i].introduce+'"/></label>';
