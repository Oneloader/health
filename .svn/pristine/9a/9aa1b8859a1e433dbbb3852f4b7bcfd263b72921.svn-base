<?php if (!defined('THINK_PATH')) exit();?><script type="text/javascript" src="/Addons/PluploadImages/plupload/plupload.full.min.js"></script>
<link rel="stylesheet" href="/Addons/PluploadImages/style/<?php echo ($css); ?>.css">
...
<script type="text/javascript">
    var uploader = new plupload.Uploader( { //创建实例的构造方法
        ...
        flash_swf_url: '/Addons/PluploadImages/plupload/Moxie.swf', //flash文件地址
        silverlight_xap_url: '/Addons/PluploadImages/plupload/Moxie.xap', //silverlight文件地址
        filters: {  
        ...
        init: {
            ...
            FileUploaded: function(up, file, info) { //文件上传成功的时候触发
                ...
                $("#" + file.id).html("<img src='" + data.path + "'/>");
            },
