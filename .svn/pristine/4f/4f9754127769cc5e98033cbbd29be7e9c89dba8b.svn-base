    ...
    <div class="lineup">
        ...
        <header class="header">
            ...
            <div class="headerBox">
                ...
                <ul class="globalNav">
                    <?php $__NAV__ = M('Channel')->field(true)->where("status=1")->order("sort")->select(); if(is_array($__NAV__)): $i = 0; $__LIST__ = $__NAV__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i; if(($nav["pid"]) == "0"): ?><li <?php if($nav["title"] == '关于我们'): ?>class="current"<?php endif; ?>>
                ...
                <div class="center_menu clearfix">
                    ...
                    <div class="right_menus float_right clearfix">
                        <ul class="small_menus float_right">
                            <?php if(is_array($top_cate)): $i = 0; $__LIST__ = $top_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$current): $mod = ($i % 2 );++$i;?><li <?php if($current["id"] == 56): ?>class="active"<?php endif; ?>>
                                    <?php if($current["id"] == 55): ?><a href="<?php echo U('Article/contact?id=79');?>"><?php elseif($current["id"] == 56): ?><a href="<?php echo U('Article/recruit?category=recruit_list');?>"><?php else: ?><a href="javascript:void(0)"><?php endif; echo ($current["title"]); ?></a>
        ...
        <section id="stage1" class="lineupHeading">
            <h1>
                <div class="img"><img src="/Public/static/yasin/new_imgs/top_bg4.jpg" class="fit" alt="Himiko"></div>
            </h1>
        </section>
        ...
        <div id="pjaxBody">
            <div class="new_content">
                ...
                <div class="recruit_lists">
                    <?php if(is_array($detail)): $i = 0; $__LIST__ = $detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><div class="recruit_item">
                            <h1 class="recruit_link clearfix"><span class="float_left"><?php echo (date('Y.m.d',$li["create_time"])); ?></span><em class="float_left"><?php echo ($li["list_title"]); ?></em><i class="iconfont icon-icon_down_circle_o float_right"></i></h1>
