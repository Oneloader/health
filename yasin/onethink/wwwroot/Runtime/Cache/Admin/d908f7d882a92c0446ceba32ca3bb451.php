...
<div class="panel panel-default">
    <div class="panel-heading">		
		<div class="fl">
            <button  class="btn btn-default " url="<?php echo U('add');?>" id="add-config">新 增</button> 
            <button  class="btn btn-default " url=" href="javascript:;">删 除</button>
            <button  class="btn btn-default list_sort" url="<?php echo U('sort?group='.I('group'),'','');?>">排序</button>        
