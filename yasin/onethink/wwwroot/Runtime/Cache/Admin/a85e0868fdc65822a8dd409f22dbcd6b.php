...
<div class="panel panel-default">
    <div class="panel-heading">	    
        <div class="tools">
            <button class="btn btn-default " id="model_add" url="<?php echo U('Model/add');?>">新 增</button>
            <button class="btn btn-default ajax-post" target-form="ids" url="<?php echo U('Model/setStatus',array('status'=>1));?>">启 用</button>
            <button class="btn btn-default ajax-post" target-form="ids" url="<?php echo U('Model/setStatus',array('status'=>0));?>">禁 用</button>
            <button class="btn btn-default " id="model_generate" url="<?php echo U('Model/generate');?>">生 成</button>
        </div>
    </div><!-- /.panel-heading -->
	<!-- 数据列表 --> 
