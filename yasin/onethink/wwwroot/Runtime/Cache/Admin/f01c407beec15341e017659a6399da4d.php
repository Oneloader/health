...
<div class="panel panel-default">
    <div class="panel-heading">		
		<div class="fl">
        <button class="btn btn-default " url="<?php echo U('add',array('pid'=>I('get.pid',0)));?>" id="add-menu">新 增</button>
        <button class="btn btn-default ajax-post confirm" url="<?php echo U('del');?>" target-form="ids">删 除</button>
        <button class="btn btn-default " url="<?php echo U('import',array('pid'=>I('get.pid',0)));?>" id="import">导 入</button>
...
$(function() {
    //导航高亮
    $('.side-sub-menu').find('a[href="<?php echo U('index');?>"]').closest('li').addClass('current active ');  
