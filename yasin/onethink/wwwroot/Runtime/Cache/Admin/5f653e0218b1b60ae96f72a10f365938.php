...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">导航英文标题<span class="check-tips">（用于显示的英文文字）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="en_title" value="<?php echo ((isset($info["en_title"]) && ($info["en_title"] !== ""))?($info["en_title"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
