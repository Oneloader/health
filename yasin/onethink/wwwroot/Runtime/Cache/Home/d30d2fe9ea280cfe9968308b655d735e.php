            ...
            <div class="center_menu clearfix">
                ...
                <div class="right_menus float_right clearfix" style="width: 100%">
                    <ul class="small_menus float_right">
                        <?php if(is_array($second)): $i = 0; $__LIST__ = $second;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sec): $mod = ($i % 2 );++$i; foreach($sec['list'] as $key=>$li):?>
                                <li <?php if($key == 0): ?>class="active"<?php endif; ?>>
                                    <a href="<?php echo U('Article/company_info?id='.$li['id'].'&next_title='.$sec['main_title'].'&detail_type=1');?>"><?php echo ($li["list_title"]); ?></a>
    ...
    <div class="breadcrumbs"></div>
        ...
        <div id="pjaxBody">
            <div class="new_content">
                <h1><span><?php echo ($detail["list_title"]); ?></span><i>/ <?php echo ($detail["en_title"]); ?></i></h1>
                <div class="new_bodys">
