...
================================================== -->
    ...
    <div class="lineup" style="background-image: url(<?php echo ($back_img); ?>);background-size: 100% auto;background-repeat: no-repeat;">
    <header class="header">
...
<div class="breadcrumbs"></div>
        <section id="stage1" class="lineupHeading" style="padding-bottom: 0px;">
            <h1>
                <div class="img"><img src="<?php echo ($banner); ?>" class="fit" alt="Himiko"></div>
            </h1>
        </section>
        <div id="pjaxBody">
            <section id="stage4" class="stageContainer current_type hospital_newBg">
                ...
                <div class="head">
                    <div class="section_head_text hospital_head_text">
                        <h2><?php echo ($list_info["list_title"]); ?></h2>
                        <p class="doc_en"><?php echo ($list_info["en_title"]); ?></p>
                    </div>
                </div>
                    ...
                    <div class="list_box_doctor float_right clearfix">
                        <ul class="doc_list_ul clearfix">
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li>
                                    <a href="<?php echo U('Article/hospital_detail?id='.$data['id'].'&next_title=1&detail_type=2');?>"><img src="<?php echo ($data["list_images"]); ?>" alt=""></a>
                                    <div class="doc_box">
                                        <p><?php echo ($data["title"]); ?></p>
                                        <span><?php echo ($data["abstract"]); ?>...</span>
                                        <a href="<?php echo U('Article/hospital_detail?id='.$data['id'].'&next_title=1&detail_type=2');?>" class="info_link clearfix">
                                            <span>查看详情</span>
