...
================================================== -->
    ...
    <div class="lineup">
        <header class="header  setHeaderPos">
            ...
            <div class="headerBox">
                ...
                <ul class="globalNav">
                    <?php $__NAV__ = M('Channel')->field(true)->where("status=1")->order("sort")->select(); if(is_array($__NAV__)): $i = 0; $__LIST__ = $__NAV__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i; if(($nav["pid"]) == "0"): ?><li <?php if($nav["title"] == '医疗布局'): ?>class="current"<?php endif; ?>>
                        ...
                        <ul class="small_menus float_right">
                            <ul class="small_menus float_right">
                                <?php if(is_array($current_cate)): $i = 0; $__LIST__ = $current_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$current): $mod = ($i % 2 );++$i;?><li <?php if($f_cate['title'] == $current['title']): ?>class="active"<?php endif; ?>>
                                    ...
                                    <i class="icons_line"></i></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                            <i class="box_line"></i>
                    </div>
                </div>
        ...
        <div id="pjaxBody">
            ...
            <div class="video_box">
                <video class="hospital_videos" src="http://www.yasin.com<?php echo ($video); ?>" controls="controls" autoplay="autoplay"></video>
            </div>
        </div>
        ...
        <div class="doctor_list">
            <div class="doctor_list_content">
                ...
                <div id="owl-demo1" class="owl-carousel">
                    <?php if(is_array($doctor)): $k = 0; $__LIST__ = $doctor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$doc): $mod = ($k % 2 );++$k;?><div class="item <?php if($k == 1): ?>active<?php endif; ?>">
                            <div class="players_box hover_doc_intro" data-name="<?php echo ($doc["list_title"]); ?>" data-skill="<?php echo ($doc["seniority"]); ?>"
                                ...
                                <img src="http://www.yasin.com<?php echo ($doc["path"]); ?>" alt="">
                            </div>
                            <div class="set_8_button outline" href="#"><span class="lines"></span></div>
                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <div class="doctor_intro_text">
                    <div class="doc_box">
                        <p><span id="data_name"><?php echo ($doctor["0"]["list_title"]); ?></span><em id="data_per"><?php echo ($doctor["0"]["position"]); ?></em></p>
                        <span>专业资历：<em id="data_skill"><?php echo ($doctor["0"]["seniority"]); ?></em></span>
                        <span>擅长：<em id="data_intro"><?php echo ($doctor["0"]["expertise"]); ?></em></span>
                    </div>
                </div>
                <ul class="mobile_doctor">
                    <?php if(is_array($doctor)): foreach($doctor as $key=>$va): ?><li>
                            <div class="players_box">
                                <a href="javascript:void(0);"><img src="http://www.yasin.com<?php echo ($doc["path"]); ?>" alt=""></a>
                                <div class="doc_box">
                                    <p><?php echo ($va["list_title"]); ?><em><?php echo ($va["position"]); ?></em></p>
                                    <span>专业资历：<em><?php echo ($va["seniority"]); ?></em></span>
                                    <span>擅长：<em><?php echo ($va["expertise"]); ?></em></span>
                                </div>
                            </div>
    ...
    <script>
        ...
        $('#owl-demo1 .item').hover(
            function(){
                $('#owl-demo1 .item').removeClass('active');
                $(this).addClass('active');
                var $hoverBox = $(this).find('.hover_doc_intro');
                $('#data_name').html($hoverBox.attr('data-name'));
                $('#data_skill').html($hoverBox.attr('data-skill'));
                $('#data_intro').html($hoverBox.attr('data-intro'));
                $('#data_per').html($hoverBox.attr('data-per'));
