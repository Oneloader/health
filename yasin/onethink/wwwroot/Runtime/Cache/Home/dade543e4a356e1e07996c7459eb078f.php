            ...
            <div class="headerBox">
                ...
                <ul class="globalNav">
                    <?php $__NAV__ = M('Channel')->field(true)->where("status=1")->order("sort")->select(); if(is_array($__NAV__)): $i = 0; $__LIST__ = $__NAV__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i; if(($nav["pid"]) == "0"): ?><li <?php if($nav["title"] == '关于我们'): ?>class="current"<?php endif; ?>>
                                <a id="bank" href="<?php echo (get_nav_url($nav["url"])); ?>" target="<?php if(($nav["target"]) == "1"): ?>_blank<?php else: ?>_self<?php endif; ?>">
                ...
                <div class="center_menu clearfix">
                    ...
                    <div class="right_menus float_right clearfix">
                        <ul class="small_menus float_right">
                            <?php if(is_array($current_cate)): $i = 0; $__LIST__ = $current_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$current): $mod = ($i % 2 );++$i;?><li <?php if($current["id"] == 55): ?>class="active"<?php endif; ?>>
