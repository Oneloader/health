...
<div id="main-container" class="container">
    ...
    <div class="span9">
        ...
        <section id="contents">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div>
                    <p><?php echo ($data["list_img"]); ?></p>
                    <img src="" alt="">
                </div>
                <div class="">
                    <h3 class="ellipsis"><a href="<?php echo U('Article/detail?id='.$data['id']);?>"><?php echo ($data["list_title"]); ?></a></h3>
                </div>
                <div>
